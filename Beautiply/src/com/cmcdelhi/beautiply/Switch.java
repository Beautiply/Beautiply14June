...
public class Switch extends CompoundButton
{
	...
	public Switch(Context context, AttributeSet attrs, int defStyle)
	{
		...
		this.switchMinWidth = a.getDimensionPixelSize(R.styleable.Switch_switchMinWidth, 200);
		
		this.textColorUnChecked = a.getColor(R.styleable.Switch_colorUnChecked, Color.BLACK);
		this.textColorChecked = a.getColor(R.styleable.Switch_colorChecked, Color.BLACK);
